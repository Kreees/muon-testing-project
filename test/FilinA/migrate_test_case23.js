...
describe('migration module test: case 23 (remove a model and an attribute with sync)', function() {

    var test_models_source_path = cfg.path + '/test/model_sets/set23/models_s/';
    var test_models_changed_path = cfg.path + '/test/model_sets/set23/models_ch/';
