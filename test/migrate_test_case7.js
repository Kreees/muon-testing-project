...
describe('migration module test: case 07 (change attribute for one model)', function() {
    var test_models_source_path = cfg.path + '/test/model_sets/set7/models_s/';
    var test_models_changed_path = cfg.path + '/test/model_sets/set7/models_ch/';
...
//        muon.once('migrate-ready', function() {
        muon.ready(function() {
            console.log('muon ready in case 7');
//            done();
 ...
 * Created by andrejfilin on 21.08.14.
 */
