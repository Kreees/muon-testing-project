...
describe('migration module test: case 13 (add a model and hasOne hasMany attribute)', function() {
    var test_models_source_path = cfg.path + '/test/model_sets/set13/models_s/';
    var test_models_changed_path = cfg.path + '/test/model_sets/set13/models_ch/';
        ...
        muon.reload(__mcfg__,function() {
            muon.ready(function() {
                try {
                    ...
                    m.diff.addOneA.should.not.eql({});
                    m.diff.addManyA.should.not.eql({});
                    done();
                }
...
//            done();
    ...
    it('should add new model and connections to the database', function(done) {
        global.__mcfg__ = { serverMode: 'migration' };
        muon.reload(__mcfg__, function() {
            muon.ready(function() {
