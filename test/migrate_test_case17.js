...
describe('migration module test: case 17 (incorrect model file)', function() {
    var test_models_source_path = cfg.path + '/test/model_sets/set17/models_ch/';
 ...
 * Created by andrejfilin on 01.09.14.
 */
