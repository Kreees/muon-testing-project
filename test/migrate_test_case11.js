...
describe('migration module test: case 11 (add connected models)', function() {
    var test_models_source_path = cfg.path + '/test/model_sets/set11/models_ch/';
...
//                done();
    ...
    it('should create an person instance in a database', function(done) {
        var Person = m.app.models.person;
...
//                per1.car_id = 1;
    ...
    it('should create a car instance in a database', function(done) {
