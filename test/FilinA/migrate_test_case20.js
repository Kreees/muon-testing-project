...
describe('migration module test: case 20 (add a model using sync)', function() {
    var test_models_source_path = cfg.path + '/test/model_sets/set20/models_ch/';
...
//                        done();
        ...
        muon.once('migrate-ready', function() {console.log('MIGRATE READY')})
    });
